...
struct gr_ctx {
  ...
  double time;
  double dt;
  int  (*config)(struct gr_ctx *, size_t, u32, u32, const char *);
  int  (*event)(struct gr_ctx *, u32 *);
};
...
static int gr_w32_config(struct gr_ctx *gr, size_t memsize, u32 xres, u32 yres,
                         const char *title)
{
  return 0;
}

static int gr_w32_event(struct gr_ctx *gr, u32 *ep)
{
  return 0;
}
